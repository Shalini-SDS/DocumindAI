  ...
  return (
    <>
      <div style={{ marginBottom: "12px" }}>
        <h2 className="dashboard-title">My Anomaly Detection</h2>
        <p className="dashboard-subtitle">AI-powered fraud and expense anomaly detection for your submissions</p>
      </div>
      ...
      <div className="grid cols-4">
        ...
        <MetricCard
          ...
          value={formatCompactCurrency(averageDeviation)}
